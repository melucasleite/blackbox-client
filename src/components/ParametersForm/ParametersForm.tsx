...
import { ANALOG_PINS, DIGITAL_PINS } from "constants/pins";

export interface IParametersFormProps {
  parameters: {};
  handleSubmit: (input: {}) => Promise<void>;
}

const ParametersForm: FC<IParametersFormProps> = ({
  parameters,
  handleSubmit,
}) => {
